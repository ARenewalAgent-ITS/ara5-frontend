...
function LoginPage() {
  ...
  return (
    <div className='flex flex-col justify-center gap-8 px-12 lg:px-0'>
      <SEO
        title='Login'
        description='LOGIN | ARA ITS (A Renewal Agent ITS) 5.0 adalah kegiatan yang diselenggarakan oleh HMIT (Himpunan Mahasiswa Teknologi Informasi) ITS periode 2023-2024 yang dimana event ini akan menjadi media untuk menyalurkan minat di bidang IT (teknologi informasi) bagi siswa SMA/SMK dan mahasiswa.'
      />
      <Typography
        as={'h3'}
        variant='h3'
