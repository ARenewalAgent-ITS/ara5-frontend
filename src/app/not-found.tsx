          ...
          <div className='relative w-full h-full xl:mt-4 xl:py-28 lg:mt-6 lg:py-24 md:mt-8 md:py-28 sm:mt-14 py-24 mt-24'>
            <div className='relative w-full flex h-full'>
              ...
              <NextImage
                ...
                width={50}
                height={74}
                className='absolute lg:-bottom-36 lg:w-[120px] lg:right-4 md:w-[65px] md:-bottom-28 md:right-36 -bottom-24 right-28 w-[50px] max-[400px]:hidden'
              />
              <NextImage
              ...
              <NextImage
                ...
                width={117}
                height={64}
                className='absolute lg:w-[120px] xl:-bottom-32 lg:right-80 lg:-bottom-40 md:w-[80px] md:-bottom-12 md:right-40 w-[70px] -bottom-10 right-32 max-[400px]:hidden'
              />
              <NextImage
